...
module ViewModel {
    ...
    //  MessageSpan
    export class Text implements ViewModelMessageSpan {
        messageSpanType = IViewModelMessageSpan.Text
            constructor(
            public text: string
            ) { }
    }

    export class Hightlight implements ViewModelMessageSpan {
        messageSpanType = IViewModelMessageSpan.Hightlight
            constructor(
            public text: string
            ) { }
    }

    export class Hyperlink implements ViewModelMessageSpan {
        messageSpanType = IViewModelMessageSpan.Hyperlink
            constructor(
            public text: string,
            public url: string
            ) { }
    ...
    //  MessageType
    export class Normal implements ViewModelMessageType {
        messageTypeType = IViewModelMessageType.Normal
            constructor(
            public person: Person
            ) { }
    }

    export class Server implements ViewModelMessageType {
        messageTypeType = IViewModelMessageType.Server
            constructor() { }
    }
    // /MessageType
    ...
    export class ChatMessage {
        ...
        constructor(
            public messageType: ViewModelMessageType,
            public messageContent: ViewModelMessageSpan[],
