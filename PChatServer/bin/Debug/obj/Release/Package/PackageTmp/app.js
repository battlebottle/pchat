...
var PCHat = (function () {
    function PCHat(viewModel) {
            ...
            if (prop.type === 3 /* ChatMessage */) {
                ...
                if (_this.me === null) {
                    ...
                    if (_this.sendMessageText !== "" || _this.vmSendDrawing.drawingData.isSome()) {
                        ...
                        connection.send(new NetworkData.ChatMessage(_this.me, _this.sendMessageText, _this.messagesSentCounter, _this.vmSendDrawing.drawingData.isSome(), _this.vmSendDrawing.drawingData.isSome(), _this.messagesSentCounter).serialise());
                        _this.userTyping = false;
                        connection.send(new NetworkData.PersonStoppedTyping(_this.me).serialise());
        ...
        //ws://localhost:1900/
        var connection = new WebSocket('ws://pchatdev.cloudapp.net:1900/');
