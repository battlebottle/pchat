...
module HTMLTemplates
{
    export class HTMLTemplates{
        ...
        static messageDiv(name: string, message: string, thumnbnail: boolean, extraMedia: boolean){
            ...
            return html
                ...
                .replace('#clickToExpandDiv', stringIf(extraMedia, clickToExpandDiv, ""))
                .replace('#thumbSize', stringIf(thumnbnail, "100", "0"))
                .replace('#messContentDiv', stringIf(thumnbnail, "messageContentDiv", ""))
            }
        }
